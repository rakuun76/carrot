/*
  ...
  - You are about to alter the column `token` on the `SMSToken` table. The data in that column could be lost. The data in that column will be cast from `String` to `Int`.
